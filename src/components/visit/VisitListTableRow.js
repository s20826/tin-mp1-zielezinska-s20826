...
function VisitListTableRow(props){
    const visit = props.visitData
    return(
        <tr>
            <td>{visit.name}</td>
            <td>{visit.firstName+" "+ visit.lastName}</td>
            <td>{getFormattedDate2(visit.date)}</td>

            <td>
                <ul className="list-actions">
                    <li>
                        <Link to={`../../animals/details/${visit.idAnimal}`}>
                    ...
                    <li>
                        <Link to={`../../visits/edit/${visit.idVisit}`}>
                    ...
                    <li>
                        <Link to={`../../visits/ifDelete/${visit.idVisit}`}>
...
export default VisitListTableRow